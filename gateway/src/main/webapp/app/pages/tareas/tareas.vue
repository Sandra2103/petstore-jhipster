<template>
  ...
  <div class="container">
    ...
    <b-modal ref="createTareaModal" id="createTareaModal" :title="$t('task.messages.new')" header-bg-variant="primary" header-text-variant="white">
      <daic-tarea-edit :tarea="tareaToEdit" @update:tarea="createTareaHandler" @cancel:tarea="cancelHandler" />
    ...
    <!-- Editar una tarea -->
    <b-modal ref="editTareaModal" id="editTareaModal" :title="$t('entity.messages.edit')" header-bg-variant="primary" header-text-variant="white">
      <daic-tarea-edit :tarea="tareaToEdit" @update:tarea="updateTareaHandler" @cancel:tarea="cancelHandler" />
      <template #modal-footer>
      <b-button variant="outline-danger" @click="cancelHandler()">{{ $t('entity.action.cancel') }}</b-button>
